    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-menu" id="navbarMenu">
                ...
                <li><a href="<?php echo e(route('partners')); ?>"><i class="fa-solid fa-handshake"></i> Mitra Kami</a></li>
            ...
            <div class="footer-content">
                <div>
                    ...
                    <div class="footer-socials">
                        ...
                        <a href="#" class="social-circle social-shopee" aria-label="Shopee"><div style="width:22px;height:22px;background:white;border-radius:8px;display:flex;align-items:center;justify-content:center;"><img src="<?php echo e(asset('logoshopee.jpeg')); ?>" alt="Shopee" style="width:18px;height:18px;object-fit:contain;"></div></a>
                    </div>
                </div>
                <div>
                    <h3>Informasi</h3>
