        ...
        <form method="GET" action="<?php echo e(route('products.index')); ?>" class="filter-bar">
            ...
            <div style="display: flex; gap: 0.5rem; align-items: flex-end;">
                ...
                <?php if($search || ($kategori_produk ?? '') || $perusahaan || $sort !== 'terbaru'): ?>
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-reset">? Reset</a>
                <?php endif; ?>
            </div>
        </form>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <?php if($search || ($kategori_produk ?? '') || $perusahaan): ?>
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-reset" style="display:inline-block;margin-top:1rem;">? Hapus Filter</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
