        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(request()->routeIs('products.apotek') || request()->routeIs('products.apotek.slug')): ?> active <?php endif; ?>" href="<?php echo e(route('products.apotek')); ?>">Produk</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 footer-section">
                    ...
                    <a href="<?php echo e(route('products.apotek')); ?>" class="footer-link">Produk</a>
...
<?php /**PATH C:\Users\Ali Attaziri\sumberindofarma\resources\views\layouts\app.blade.php ENDPATH**/ ?>