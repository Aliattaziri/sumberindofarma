    ...
    <div class="data-table-wrap">
        <form id="bulkDeleteForm" method="POST" action="<?php echo e(route('admin.produk.destroyMany')); ?>" novalidate>
            ...
            <div class="bulk-actions">
                ...
                <button type="submit" class="bulk-btn bulk-btn-danger" id="bulkDeleteBtn" disabled formnovalidate
                    ...
                    <td style="vertical-align:top;">
                        ...
                        <?php else: ?>
                            <div class="med-img-placeholder">
                                <?php echo e(\App\Models\ProductCategory::iconFor($medicine->kategori_produk ?? 'OBAT')); ?>
