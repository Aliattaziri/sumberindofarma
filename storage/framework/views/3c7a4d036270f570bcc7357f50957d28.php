<?php $__env->startSection('title', 'Dashboard - Admin Sumberindo Farma Tama'); ?>
...
<div class="stats-grid" style="margin-top:1rem;">
    ...
    <div class="stat-card">
        ...
        <div class="stat-value" style="color:#B91C1C;" id="stat-stok"><?php echo e(number_format($totalStok)); ?></div>
    </div>
    <div class="stat-card" style="border-top-color:#ef4444;">
        <div class="stat-label">Stok Rendah (&lt;5)</div>
        <div class="stat-value" style="color:#ef4444;" id="stat-lowstok"><?php echo e($lowStok); ?></div>
    </div>
    <div class="stat-card" style="border-top-color:#ef4444;">
        <div class="stat-label">Total Banner</div>
        <div class="stat-value" style="color:#ef4444;"><?php echo e($totalBanners); ?></div>
    </div>
...
<div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
        ...
        <a href="<?php echo e(route('admin.produk.index')); ?>" style="font-size:0.8rem;color:#B91C1C;text-decoration:none;">Lihat semua →</a>
    </div>
            ...
            <tbody id="produk-tbody">
                <?php $__empty_1 = true; $__currentLoopData = $latestProduk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <?php if($p->stok > 10): ?>
                                <span style="color:#ef4444;font-weight:700;"><?php echo e($p->stok); ?></span>
                            <?php elseif($p->stok > 0): ?>
                                <span style="color:#ef4444;font-weight:700;"><?php echo e($p->stok); ?></span>
                            <?php else: ?>
...
<div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
        ...
        <a href="<?php echo e(route('admin.purchase-history.index')); ?>" style="font-size:0.8rem;color:#B91C1C;text-decoration:none;">Lihat semua →</a>
    </div>
    <div class="table-container">
        <table class="table">
            <thead>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($order->buyer_type === 'apotik' ? 'Apotik' : ($order->buyer_type === 'toko_obat' ? 'Toko Obat' : ($order->buyer_type === 'pbf' ? 'PBF' : 'Umum'))); ?></td>
...
<div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
        ...
        <a href="<?php echo e(route('admin.banners.index')); ?>" style="font-size:0.8rem;color:#B91C1C;text-decoration:none;">Kelola banner →</a>
    </div>
    <?php if($totalBanners === 0): ?>
        <p style="text-align:center;color:#6b7280;padding:1.5rem 0;">Belum ada banner. <a href="<?php echo e(route('admin.banners.create')); ?>" style="color:#B91C1C;">Tambah sekarang →</a></p>
    <?php else: ?>
        <div style="margin-bottom:0.75rem;font-size:0.82rem;color:#6b7280;">
            <span style="color:#ef4444;font-weight:600;"><?php echo e($activeBanners); ?></span> aktif &nbsp;/&nbsp;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\sumberindofarma\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>