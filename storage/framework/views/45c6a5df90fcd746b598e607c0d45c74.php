<?php $__env->startSection('title', 'Tambah Produk Promo - Admin Sumberindo Farma Tama'); ?>
<?php $__env->startSection('page-title', '🏷️ Tambah Produk Promo'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <textarea 
                ...
                style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 0.375rem; font-family: inherit;"
                required
            ><?php echo e(old('konten')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            >
                ...
                <option value="diskon"        <?php echo e(old('tipe') === 'diskon'        ? 'selected' : ''); ?>>🏷️ Diskon</option>
                <option value="flash_sale"    <?php echo e(old('tipe') === 'flash_sale'    ? 'selected' : ''); ?>>⚡ Flash Sale</option>
                <option value="bundling"      <?php echo e(old('tipe') === 'bundling'      ? 'selected' : ''); ?>>📦 Bundling</option>
                <option value="promo_spesial" <?php echo e(old('tipe') === 'promo_spesial' ? 'selected' : ''); ?>>🎁 Promo Spesial</option>
            </select>
