<?php $__env->startSection('title', 'Import Produk - Admin Sumberindo Farma Tama'); ?>
...
<div class="form-card">
    ...
    <div class="form-body">
        ...
        <div id="dropZone" class="upload-zone" onclick="document.getElementById('fileInput').click()"
            ...
            <form action="<?php echo e(route('admin.produk.import.process')); ?>" method="POST" enctype="multipart/form-data" id="submitForm">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\sumberindofarma\resources\views\admin\produk\import.blade.php ENDPATH**/ ?>