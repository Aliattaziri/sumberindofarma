...
<div class="global-shell" id="globalDashboard"
     ...
     data-initial-omzet="<?php echo e((float) $totalOmzetGlobal); ?>">
    ...
    <section class="global-grid">
        ...
        <article class="global-kpi">
            ...
            <div class="value" id="global-total-omzet">Rp <?php echo e(number_format($totalOmzetGlobal, 0, ',', '.')); ?></div>
        </article>
    </section>
    ...
    <section class="global-layout">
        <article class="global-panel">
            ...
            <div class="global-list" id="global-list-outlet">
                <?php $__empty_1 = true; $__currentLoopData = $historyByOutlet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $percent = $totalOmzetGlobal > 0 ? (($row['omzet'] / $totalOmzetGlobal) * 100) : 0;
                    ?>
                    <div class="global-item">
                        <div class="global-item-head">
                            <div class="global-item-name"><?php echo e($row['outlet']); ?></div>
                            <div class="global-item-tx"><?php echo e(number_format($row['transaksi'])); ?> transaksi</div>
                        </div>
                        <div class="global-progress"><span data-width="<?php echo e(min(100, round($percent, 2))); ?>"></span></div>
                        <div class="global-omzet">Rp <?php echo e(number_format($row['omzet'], 0, ',', '.')); ?> • <?php echo e(number_format($percent, 1, ',', '.')); ?>%</div>
                    </div>
        ...
        <article class="global-panel">
            ...
            <div class="global-list" id="global-list-channel">
                <?php $__empty_1 = true; $__currentLoopData = $historyByChannel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $percent = $totalOmzetGlobal > 0 ? (($row['omzet'] / $totalOmzetGlobal) * 100) : 0;
                    ?>
                    <div class="global-item">
                        <div class="global-item-head">
                            <div class="global-item-name"><?php echo e($row['channel']); ?></div>
                            <div class="global-item-tx"><?php echo e(number_format($row['transaksi'])); ?> transaksi</div>
                        </div>
                        <div class="global-progress"><span data-width="<?php echo e(min(100, round($percent, 2))); ?>"></span></div>
                        <div class="global-omzet">Rp <?php echo e(number_format($row['omzet'], 0, ',', '.')); ?> • <?php echo e(number_format($percent, 1, ',', '.')); ?>%</div>
    ...
    <section class="global-table-card">
        <div class="global-table-head">
            ...
            <a href="<?php echo e(route('admin.purchase-history.index')); ?>" class="global-table-link">Lihat semua</a>
        </div>
        <div class="table-container">
            <table class="global-table">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentGlobalOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($order->created_at->format('d M Y H:i')); ?></td>
                        <td><?php echo e($order->source_outlet ?: '-'); ?></td>
                        <td><?php echo e($order->buyer_name ?: '-'); ?></td>
                        <td><?php echo e($order->buyer_type === 'apotik' ? 'Apotek' : ($order->buyer_type === 'toko_obat' ? 'Toko Obat' : ($order->buyer_type === 'pbf' ? 'PBF' : 'Umum'))); ?></td>
                        <td>Rp <?php echo e(number_format($order->effective_total, 0, ',', '.')); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
(function () {
    ...
    elTotalOmzet.setAttribute('data-raw-value', '<?php echo e((int) $totalOmzetGlobal); ?>');
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\sumberindofarma\resources\views\admin\dashboard-global.blade.php ENDPATH**/ ?>