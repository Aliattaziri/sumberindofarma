...
window.cartSettings = Object.assign({}, window.cartSettings || {}, {
    storageKey: <?php echo json_encode(auth()->check() ? 'sumberindofarmatama_cart_user_' . auth()->user()->id . '_grosir' : 'sumberindofarmatama_cart_grosir', 15, 512) ?>,
    receiptStoreName: 'Sumberindo Farma Tama - Grosir',
    receiptFilePrefix: 'struk-grosir-sumberindo'
});
</script>
<?php echo $__env->make('partials.cart_grosir', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\sumberindofarma\resources\views\prescriptions.blade.php ENDPATH**/ ?>