...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="kat-selector" id="katSelector">
                        ...
                        <label class="kat-card kat-card-custom <?php echo e(!in_array(old('kategori_produk','OBAT'), $kategoriOptions) && old('kategori_produk') ? 'selected' : ''); ?>"
                               onclick="toggleCustomKat(this)" id="katCardCustom">
                            <input type="radio" name="kategori_produk" value="__custom__" id="radioCustom"
                                   <?php echo e(!in_array(old('kategori_produk','OBAT'), $kategoriOptions) && old('kategori_produk') ? 'checked' : ''); ?>>
                    ...
                    <div id="customKatWrap" style="margin-top:0.6rem;display:<?php echo e(!in_array(old('kategori_produk','OBAT'), $kategoriOptions) && old('kategori_produk') ? 'block' : 'none'); ?>;">
                        <input type="text" id="customKatInput"
                               class="form-input"
                               placeholder="Ketik nama kategori baru, contoh: NUTRISI"
                               value="<?php echo e(!in_array(old('kategori_produk','OBAT'), $kategoriOptions) ? old('kategori_produk','') : ''); ?>"
                    ...
                    <input type="hidden" name="kategori_produk" id="kategoriProdukFinal"
                           value="<?php echo e(old('kategori_produk', 'OBAT')); ?>">
