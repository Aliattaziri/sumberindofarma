...
<div class="detail-page-header">
    <div class="container">
        <div class="breadcrumb-custom">
            ...
            <span>/</span>
            <a href="<?php echo e(route('products.apotek')); ?>">Produk</a>
            <span>/</span>
            ...
            <div class="detail-info">
                ...
                <div style="background:#f9fafb;border-radius:12px;padding:1.25rem;margin:1.25rem 0;border:1px solid #e5e7eb;">
                    ...
                    <div style="margin-bottom:0.85rem;padding:0.65rem 1rem;background:#fef2f2;border-radius:8px;display:flex;justify-content:space-between;align-items:center;">
                        ...
                        <span id="totalHarga" style="font-size:1rem;font-weight:800;color:#991B1B;"><?php echo e($medicine->getFormattedPrice()); ?></span>
                    </div>
                ...
                <a href="<?php echo e(route('products.apotek')); ?>" style="display:flex;align-items:center;justify-content:center;gap:0.5rem;padding:0.65rem;border:1.5px solid #e5e7eb;border-radius:10px;color:#6b7280;text-decoration:none;font-weight:600;font-size:0.875rem;transition:all 0.2s;">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\sumberindofarma\resources\views\medicines\detail.blade.php ENDPATH**/ ?>