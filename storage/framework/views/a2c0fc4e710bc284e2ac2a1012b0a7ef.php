...
<div class="outlet-modal" id="outletModal">
  ...
  <div class="outlet-modal-list">
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Sintang'])); ?>" class="outlet-choice">1. Alfa Sintang</a>
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Air Upas'])); ?>" class="outlet-choice">2. Alfa Air Upas</a>
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Kendawangan'])); ?>" class="outlet-choice">3. Alfa Kendawangan</a>
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Balai Berkuak'])); ?>" class="outlet-choice">4. Alfa Balai Berkuak</a>
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Nanga Tayap'])); ?>" class="outlet-choice">5. Alfa Nanga Tayap</a>
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Tumbang Titi'])); ?>" class="outlet-choice">6. Alfa Tumbang Titi</a>
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Sosok'])); ?>" class="outlet-choice">7. Alfa Sosok</a>
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Bodok'])); ?>" class="outlet-choice">8. Alfa Bodok</a>
    <a href="<?php echo e(route('products.apotek', ['perusahaan' => 'Alfa Kembayan'])); ?>" class="outlet-choice">9. Alfa Kembayan</a>
