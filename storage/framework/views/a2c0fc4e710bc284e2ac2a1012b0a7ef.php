  ...
  <div class="container">
    <div class="promo-grid">
        ...
        <div class="promo-card-content">
                    <img src="<?php echo e(asset('logo b2b.png')); ?>" alt="B2B TokoPro" class="promo-b2b-logo">
...
<section style="padding: 2.5rem 0 3rem; background: linear-gradient(180deg, #0b0b0d 0%, #111827 100%); border-top: 1px solid rgba(255,255,255,0.08);">
    <div class="container" style="max-width: 1500px; margin: 0 auto; padding: 0 1rem;">
        <div style="display: flex; align-items: center; justify-content: space-between; gap: 1rem; margin-bottom: 1.5rem; flex-wrap: wrap;">
            ...
            <a href="<?php echo e(route('news.index')); ?>" style="text-decoration: none; color: #f9fafb; font-weight: 700; font-size: 0.9rem; padding: 0.7rem 1rem; border: 1px solid rgba(255,255,255,0.2); border-radius: 999px; background: rgba(255,255,255,0.03);">Lihat Semua</a>
        </div>
        ...
        <?php if($latestNews->count() > 0): ?>
            <div style="display: flex; gap: 1rem; overflow-x: auto; overflow-y: hidden; white-space: nowrap; padding-bottom: 0.75rem; scroll-snap-type: x proximity;" class="news-scroll">
                ...
                <?php $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('news.index', ['news_id' => $news->id])); ?>" class="news-card" style="text-decoration: none; color: inherit; display: block; min-width: 0; border-radius: 1.15rem; overflow: hidden; background: #1a202c; border: 1.5px solid #4a5568; box-shadow: 0 8px 20px rgba(0,0,0,0.4); transition: transform 0.2s ease, border-color 0.2s ease; scroll-snap-align: start;">
                        <div class="news-media" style="position: relative; width: 100%; --news-ratio: <?php echo e($news->ratio === '9:16' ? '9 / 16' : '3 / 4'); ?>; aspect-ratio: var(--news-ratio); background: #111827; overflow: hidden;">
                            <?php if($news->file): ?>
                                <?php if(str_contains(strtolower($news->file), '.mp4') || str_contains(strtolower($news->file), '.webm') || str_contains(strtolower($news->file), '.mov')): ?>
                                    <video src="<?php echo e(asset('storage/' . $news->file)); ?>" muted loop playsinline style="width: 100%; height: 100%; object-fit: contain; display: block; background: #dfeaf2; transition: transform 0.2s ease;"></video>
                                <?php else: ?>
                                    <img src="<?php echo e(asset('storage/' . $news->file)); ?>" alt="<?php echo e($news->judul); ?>" style="width: 100%; height: 100%; object-fit: contain; display: block; background: #dfeaf2; padding: 0.25rem; transition: transform 0.2s ease;">
                                <?php endif; ?>
                            <?php else: ?>
                        ...
                        <div style="padding: 0.8rem 0.7rem 0.75rem; background: rgba(17,24,39,0.98);">
                            <div style="display: flex; align-items: center; justify-content: flex-start; gap: 0.5rem; margin-bottom: 0.4rem;">
                                <div style="font-size: 0.7rem; color: #d1d5db;"><?php echo e($news->created_at->translatedFormat('d M Y')); ?></div>
                            </div>
        ...
        <div class="pbf-profile-wrap">
            ...
            <div class="pbf-gallery-grid">
                ...
                <div class="pbf-photo-template pbf-photo-template-adelia">
                    <img src="<?php echo e(asset('MOBIL EKSPEDISI ADELIA .png')); ?>" alt="Foto Armada Pengiriman Mobil Ekspedisi Adelia">
