<?php $__env->startSection('title', 'Import Obat - Admin Sumberindo Farma Tama'); ?>
...
<div class="form-card" style="margin-bottom: 1.5rem;">
    ...
    <div class="form-body">
        <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap; margin-bottom: 1rem;">
            <a href="<?php echo e(route('admin.medicines.import.template')); ?>" class="btn-save" style="background: #ef4444; text-decoration: none;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\sumberindofarma\resources\views\admin\medicines\import.blade.php ENDPATH**/ ?>