...
<div class="products-main">
    <div class="container">
        ...
        <form method="GET" action="<?php echo e(route('products.apotek')); ?>" class="filter-bar">
            ...
            <div style="display: flex; gap: 0.5rem; align-items: flex-end;">
                ...
                <?php if($search || ($kategori_produk ?? '') || $perusahaan || $sort !== 'terbaru'): ?>
                    <a href="<?php echo e(route('products.apotek')); ?>" class="btn-reset"><i class="fa-solid fa-xmark"></i> Reset</a>
                <?php endif; ?>
            </div>
        </form>
                    ...
                    <div class="medicine-card">
                        ...
                        <div class="medicine-body">
                            <?php if($medicine->kategori): ?>
                                <div class="medicine-origin" style="font-size:0.75rem;color:#6b7280;margin-bottom:0.45rem;font-weight:600;">Toko: <?php echo e($medicine->kategori); ?></div>
                            <?php endif; ?>
                            ...
                            <button class="btn-cart" onclick="addToCart(<?php echo e($medicine->id); ?>, '<?php echo e(addslashes($medicine->nama_obat)); ?>', <?php echo e($medicine->harga); ?>, '<?php echo e($medicine->gambar ? url('storage/'.$medicine->gambar) : ''); ?>', '<?php echo e(addslashes($medicine->brand ?: $medicine->kategori)); ?>', this)">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <?php if($search || ($kategori_produk ?? '') || $perusahaan): ?>
                    <a href="<?php echo e(route('products.apotek')); ?>" class="btn-reset" style="display:inline-block;margin-top:1rem;"><i class="fa-solid fa-xmark"></i> Hapus Filter</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
...
window.cartSettings = Object.assign({}, window.cartSettings || {}, {
    storageKey: <?php echo json_encode(auth()->check() ? 'sumberindofarmatama_cart_user_' . auth()->user()->id . '_produk_umum' : 'sumberindofarmatama_cart_produk_umum', 15, 512) ?>,
    receiptStoreName: 'Sumberindo Farma Tama',
    receiptFilePrefix: 'struk-retail-sumberindo'
});
</script>
<?php echo $__env->make('partials.cart_products', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\sumberindofarma\resources\views\products.blade.php ENDPATH**/ ?>