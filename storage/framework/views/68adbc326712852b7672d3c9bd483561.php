            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kategori" class="form-input <?php echo e($errors->has('kategori') ? 'is-invalid' : ''); ?>"
                           value="<?php echo e(old('kategori', $medicine->kategori)); ?>" required>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" name="harga" class="form-input <?php echo e($errors->has('harga') ? 'is-invalid' : ''); ?>"
                               step="1" min="0" value="<?php echo e(old('harga', $medicine->harga)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="stok" class="form-input <?php echo e($errors->has('stok') ? 'is-invalid' : ''); ?>"
                               min="0" value="<?php echo e(old('stok', $medicine->stok)); ?>" required>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" name="terjual" class="form-input <?php echo e($errors->has('terjual') ? 'is-invalid' : ''); ?>"
                               min="0" value="<?php echo e(old('terjual', $medicine->terjual ?? 0)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="grade" class="form-input <?php echo e($errors->has('grade') ? 'is-invalid' : ''); ?>"
                               value="<?php echo e(old('grade', $medicine->grade)); ?>">
