...
<section class="apotek-hero">
    <div class="container">
        <div class="apotek-badge"><i class="fa-solid fa-store"></i> <?php echo e($perusahaan ?: 'Apotek Medistra'); ?></div>
        <h1>Katalog Produk <?php echo e($perusahaan ?: 'Apotek Medistra'); ?></h1>
