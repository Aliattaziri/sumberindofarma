...
@section('title', 'Pilih Outlet Apotek Alfa Group')
...
<section class="outlets-section">
    <div class="container">
        <p class="sec-title">{{ count($outlets) }} Outlet Tersedia</p>
        <p class="sec-sub">Klik outlet untuk melihat katalog produk di lokasi tersebut.</p>

        <div class="outlets-grid">
            @foreach($outlets as $outlet)
            <a href="{{ route('products.apotek', ['outlet' => $outlet['name']]) }}" class="outlet-card">
